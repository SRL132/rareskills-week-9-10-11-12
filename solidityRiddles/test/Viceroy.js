...
describe("Viceroy", async function () {
    ...
    it("conduct your attack here", async function () {
        const governanceAttackerWithSignature = await ethers.getContractAt("GovernanceAttacker", attacker.address);
        await governanceAttackerWithSignature.attack(governance.address);
    });
