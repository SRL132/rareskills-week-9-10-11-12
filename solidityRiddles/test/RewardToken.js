...
describe(NAME, function () {
    ...
    describe("exploit", async function () {
        let attackerContract, NFTToStakeContract, depositoorContract, rewardTokenContract, attackerWallet;
        before(async function () {
            ({ attackerContract, NFTToStakeContract, depositoorContract, rewardTokenContract, attackerWallet } =
