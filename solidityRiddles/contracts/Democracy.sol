...
contract Democracy is Ownable, ERC721 {
    ...
    //@audit this function can force change ownership
    ...
    function vote(
        ...
        //@audit totalCap can be exceeded
    ...
    //@audit this function is the one used to drain the contract balance
    function withdrawToAddress(address address_) external onlyOwner {
        payable(address_).call{value: address(this).balance}("");
    }
    //@this function can be used to transfer the ownership and unlock withdraw
