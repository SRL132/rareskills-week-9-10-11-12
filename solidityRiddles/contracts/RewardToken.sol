...
contract Depositoor is IERC721Receiver {
    ...
    //@Audit possible reentrancy point
    ...
    //@audit this is the function that sends the reward tokens to the user
...
contract RewardTokenAttacker is IERC721Receiver {
    ...
    function deposit(NftToStake _nft, RewardToken _rewardToken, Depositoor _depositoor) public {
        nft = _nft;
        rewardToken = _rewardToken;
